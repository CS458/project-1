...
async function copyTest(driver, emailInput, passwordInput) {
	await driver.actions().click(emailInput).keyDown(Key.CONTROL).sendKeys("a").keyUp(Key.CONTROL).perform();
	await driver.actions().keyDown(Key.CONTROL).sendKeys("c").keyUp(Key.CONTROL).perform();
	await driver.actions().click(passwordInput).keyDown(Key.CONTROL).sendKeys("a").keyUp(Key.CONTROL).perform();
	await driver.actions().keyDown(Key.CONTROL).sendKeys("c").keyUp(Key.CONTROL).perform();
	await driver.actions().click(passwordInput).keyDown(Key.CONTROL).sendKeys("a").keyUp(Key.CONTROL).perform();
